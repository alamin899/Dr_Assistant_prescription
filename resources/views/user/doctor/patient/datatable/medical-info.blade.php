...
<a href="#" data-toggle="modal" data-target="#primaryInvestigationModal" onclick="return addValue('{{$patient->id}}','{{$patient->primary_investigation}}')"><i class="fa fa-plus-circle"></i> &nbsp; Primary Investigation </a>
<br>

...
$(document).ready(function () {
    ...
    $("#saveTemplate").on('click', function (e) {
        $(this).saveTemplate('/application/save-template', true);
    });

    // Update template
    $("#updateTemplate").on('click', function (e) {
        var url = '/application/update-template/' + updateTemplateId;
    ...
    $.fn.getPrescriptionDetails = function (prescriptionId) {
        ...
        $.get('/application/api/prescription-details/' + prescriptionId, function (data) {
            console.log(data);
            var _drugs = [];
    ...
    $.fn.getPatientDetails = function (patientId) {
        ...
        if (patientId != '') {
            $.get('/application/api/patient-details/' + patientId, function (data) {
    ...
    $.fn.savePrescription = function () {
        ...
        if (drugList.length != 0) {
            if (patientId != null) {
                ...
                $.ajax({
                    url: '/application/save-prescription',
                    type: 'post',
